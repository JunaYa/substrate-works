...
pub use frame_support::{
	...
	parameter_types,
	traits::{
		ConstU128, ConstU32, ConstU64, ConstU8, Contains, KeyOwnerProofSystem, Randomness,
...
/// Import the kuaidi pallet.
pub use pallet_kuaidi;
...
/// Configure the pallet-kuaidi100 in pallets/template.
impl pallet_kuaidi::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type AuthorityId = pallet_kuaidi::crypto::TestAuthId;
}
